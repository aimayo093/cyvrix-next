      ...
      <div className="max-w-7xl mx-auto px-5 lg:px-8">
        ...
        <div className="max-w-4xl">
          ...
          >
            ...
            <h1 className="font-outfit text-4xl md:text-6xl font-black text-white leading-tight mb-8">
              {study.title}
            </h1>
            
            <div className="flex flex-wrap gap-8 mb-16 p-6 rounded-2xl bg-[#020817] border border-white/10">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-white">{study.timeline}</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-white">{study.clientType}</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          <div className="grid gap-16">
            <section>
              ...
              <p className="text-xl text-slate-400 leading-relaxed italic border-l-4 border-white/10 pl-8 py-2">
                "{study.challenge}"
              </p>
            </section>
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {study.services.map((service) => (
                  <div key={service} className="flex items-center gap-3 p-4 rounded-xl bg-[#020817] border border-white/5 shadow-sm">
