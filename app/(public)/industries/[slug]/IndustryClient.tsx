        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          ...
          <div className="mt-12 grid gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
            <div>
              ...
              <p className="mt-7 max-w-3xl text-lg leading-8 text-slate-300">{industry.summary}</p>
            </div>
            <Link href={industry.journey.consultationHref} className="inline-flex min-h-14 items-center justify-center gap-2 rounded-md bg-[#2691F0] px-7 font-bold text-white shadow-lg shadow-[#2691F0]/20 transition-colors hover:bg-white hover:text-[#041635]">Discuss your technology priorities <ArrowRight className="h-5 w-5" /></Link>
          </div>
        </div>
      </section>
